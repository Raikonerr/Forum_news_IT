...
@section('content')  
    ...
    <section class=" w-full py-0 bg-white lg:py-20 ">
        <div class="flex flex-col items-center justify-center  px-10 mx-auto max-w-7xl xl:px-5 lg:flex-row">
            
            <form action="{{ route('register') }}" method="post" class="flex flex-col items-center w-full justify-center px-10 pt-5 pb-20 lg:pt-20 lg:flex-row">
                @csrf
                <div class="relative z-10 w-full max-w-2xl mt-20 lg:mt-0 lg:w-5/12">
                    <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                        <h4 class="w-full font-serif text-4xl font-medium leading-snug">Signup <br></h4>
                        <div class="relative w-full mt-6 space-y-8">
                            ...
                            <div class="relative">
                                ...
                                <input name="name" value="{{ old('name') }}" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black  @error('name') border-red-500 @enderror" placeholder="Your name">
                                @error('name')
                            ...
                            <div class="relative">
                                <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Username</label>
                                <input name="username" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black @error('username') border-red-500 @enderror" value="{{ old('username') }}" placeholder="Your username">
                                @error('username')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="relative">
                                ...
                                <input name="email" type="email" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black @error('email') border-red-500 @enderror" value="{{ old('email') }}" placeholder="Your email">
                                @error('email')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="relative">
                                ...
                                <input name="phone" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black @error('phone') border-red-500 @enderror" value="{{ old('phone') }}" placeholder="Your Phone">
                                @error('phone')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="relative">
                                <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Your Password</label>
                                <input name="password" type="password" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black @error('username') border-red-500 @enderror" value="{{ old('password') }}" placeholder="Your Password">
                                @error('password')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="relative">
                                <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Repeat your password</label>
                                <input name="password_confirmation" type="password" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black @error('username') border-red-500 @enderror" value="{{ old('password_confirmation') }}" placeholder="Repeat your password">
                            ...
                            <div class="relative">
                                <button type="submit" class="inline-block w-full px-5 py-4 text-xl font-medium text-center text-white transition duration-200 bg-blue-400 rounded-lg hover:bg-blue-700 ease">Submit</button>
                            </div>
